...
\begin{document}
	...
	\part{Jedeme na to}
		...
		\newpage
		\section{Seznamy}
		Řekne-li se seznam (případně výčet), nejspíš ne úplně každý bude mít jasnou představu o čem je řeč. Při čtení zdrojového kódu tohoto dokumentu jste si mohli seznamu všimnout například v kapitole č.\ref{pismo}, pojednávající písmech.
		\\
